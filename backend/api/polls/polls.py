...
from core.deps import get_current_user, get_supabase, get_supabase_admin, get_current_user_optional
...
def request_voting_auth_token(
    ...
    return {
        "message": f"Se ha enviado un código de autenticación a {user_email}",
        "email": user_email
    }
