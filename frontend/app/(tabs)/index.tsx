    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <ThemedView style={styles.stepContainer}>
          ...
          <ThemedText>
            Vecinus es tu plataforma para gestionar y conectar con tu comunidad
            de vecinos de manera fácil y eficiente.
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.stepContainer}>
          ...
          <ThemedText>
            ...
            con el asistente virtual de tu comunidad{"\n"}• Reserva espacios
        ...
        <ThemedView style={styles.stepContainer}>
          ...
          <ThemedText>
            Usa el <ThemedText type="defaultSemiBold">menú lateral</ThemedText>{" "}
            (desliza desde la izquierda o toca el ícono de menú) para navegar
