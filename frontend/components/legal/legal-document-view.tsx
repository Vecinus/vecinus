...
const legalSections: LegalSection[] = [
  {
    ...
    items: [
      ...
      'Votaciones Digitales: Sistema de votación ponderada por coeficiente de propiedad con integridad garantizada. Exención de morosos (Art. 15.2 LPH), tokens únicos de votación, autenticación por correo y doble mayoría.',
      'Comunicación y Asistencia: Chat de vecinos, tablón de anuncios con estados (borrador/publicado) y programación de publicaciones, y Chatbot informativo basado en normativa interna.',
  ...
  },
  {
    ...
    items: [
      ...
      'En incidencias, las imágenes deben centrarse en el desperfecto; no deben incluir rostros ni matrículas. Nota: los metadatos (GPS) no se eliminan automáticamente.',
      'La plataforma utiliza únicamente cookies técnicas y almacenamiento local necesario para mantener la sesión.',
      'Anonimización de cuenta: los usuarios pueden solicitar la eliminación de su perfil, que sustituye su nombre por "Deleted User [ID]" y su email por "deleted_[ID]@deleted.com". El sistema genera un identificador único de recuperación.',
      'Recuperación de cuenta: usuarios con cuentas anonimizadas pueden recuperarlas con su identificador de recuperación y contraseña, proporcionando nuevo nombre, email y avatar.',
      'Los derechos de acceso, rectificación, supresión y portabilidad pueden ejercerse por correo electrónico o mediante las opciones de anonimización/recuperación integradas en la aplicación.',
    ],
  },
  {
    id: "terminos",
    ...
    items: [
      ...
      "Sistema de votaciones: el voto es nominal y vinculado a cada propiedad (LPH Art. 15 y 17). Se calcula ponderado según coeficiente de propiedad. Propiedades morosas (Art. 15.2 LPH) quedan excluidas del censo electoral. Los resultados, calculados mediante doble mayoría (personas + cuotas), tendrán carácter vinculante según condiciones de aprobación.",
      "Tablón de anuncios: solo administradores y presidentes pueden crear anuncios. Los anuncios en estado borrador son visibles solo para administradores; los publicados lo son para toda la comunidad. Opcionalmente pueden programarse para publicación automática en fecha y hora especificadas.",
  ...
  },
  {
    ...
    items: [
      ...
      'Se aplican medidas de seguridad como cifrado y control de acceso por roles (Admin, Presidente, Vecino, Empleado).',
      'Tratamiento de datos de votaciones: los votos se registran de forma nominal vinculados a propiedades y coeficientes, cumpliendo con requisitos legales de la LPH. Los datos se conservan para trazabilidad y cálculo de resultados.',
      'Tratamiento de anuncios: el contenido se almacena según instrucciones de administración. Las imágenes se alojan en infraestructura de terceros (CDN).',
      'Tratamiento en anonimizaciones: cuando un usuario solicita eliminar su cuenta, sus datos personales se sustituyen por valores anonimizados. Se genera un ID de recuperación único que el usuario puede usar posteriormente.',
      'La comunidad autoriza el uso de proveedores terceros necesarios para hosting, CDN de imágenes e infraestructura de IA.',
