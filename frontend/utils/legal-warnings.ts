...
const warnings: Record<LegalWarningType, string> = {
  voice_signature:
    'Esta firma tiene carácter de Firma Electrónica Simple según el Reglamento eIDAS (UE). Por favor, revisa la transcripción, no nos hacemos responsables de errores causados por la IA.',
  document_upload:
